...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hyper-local gig marketplace turning everyday tasks into a verified financial passport." },
      { property: "og:title", content: "AreaHustle" },
      { property: "og:description", content: "Hyper-local gig marketplace for the informal economy." },
